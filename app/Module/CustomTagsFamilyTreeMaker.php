...
class CustomTagsFamilyTreeMaker extends AbstractModule implements ModuleConfigInterface, ModuleCustomTagsInterface
{
    ...
    public function customTags(): array
    {
        return [
            ...
            'INDI:*:SOUR:_APID' => new CustomElement('Ancestry.com source ID'),
            ...
            // Special individual ID code for later file comparisons
            'INDI:_UNKN'        => new CustomElement(I18N::translate('Unknown')),
            ...
            '_MISN'                    => new CustomElement('Mission'),
